...
RAG_PROMPT = ChatPromptTemplate.from_messages([
    (
        "system",
        "Bạn là trợ lý AI hữu ích. Chỉ trả lời dựa trên context được cung cấp. "
        "Nếu context không chứa câu trả lời, hãy nói rõ rằng bạn không tìm thấy "
        "thông tin; không được suy đoán.\n\nContext:\n{context}",
    ),
    ("human", "{question}"),
])
